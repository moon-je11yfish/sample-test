...
<table border="1" align="center" width="100%" >
   ...
   <c:forEach var="member" items="${membersList}">
	   ...
	   <tr align="center">
	      ...
	      <c:url var="url2" value="/memberUpdateForm.do">
	      ...
	      <c:url var="url1" value="/delMember.do"><!-- pro14 urlTest.jsp 참고 -->
			<c:param name="id" value="${member.id}"/>
		  </c:url>	
...
<a href="${contextPath}/signup.do"><h1 style="text-align:center">회원 가입</h1></a>
</body>
</html>
